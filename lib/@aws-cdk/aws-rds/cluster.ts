...
import { IClusterEngine } from '@aws-cdk/aws-rds';
import { DatabaseClusterAttributes, IDatabaseCluster } from '@aws-cdk/aws-rds';
...
import { BackupProps, InstanceProps, Login, RotationMultiUserOptions } from '@aws-cdk/aws-rds';
import { DatabaseProxy, DatabaseProxyOptions, ProxyTarget } from '@aws-cdk/aws-rds';
  ...
  private createInstances(props: DatabaseClusterProps, cluster: CfnDBCluster, subnetGroup: CfnDBSubnetGroup, portAttribute: number) {
    ...
    for (let i = 0; i < instanceCount; i++) {
      ...
      const instance = new CfnDBInstance(this, `Instance${instanceIndex}`, {
        ...
        // PATCHED: == add parameter
        autoMinorVersionUpgrade: false,
        allowMajorVersionUpgrade: false,
        deleteAutomatedBackups: true,
        enablePerformanceInsights: instanceType.toString().includes('t3')? false: true,
        // == PATCHED
      });
